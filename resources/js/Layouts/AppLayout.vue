...
<template>
    <div>
        ...
        <div class="min-h-screen bg-gray-900 dark:bg-gray-900 dark:text-white">
                                    ...
                                    <template #content>
                                        <div class="w-60">
                                            ...
                                            <template v-if="$page.props.jetstream.hasTeamFeatures">
                                                ...
                                                <!-- Team Settings -->
                                                <template v-if="$page.props.user.isMemberOfATeam && $page.props.user.current_team">
                                                ...
                                                <!-- Team Switcher -->
                                                <template v-if="$page.props.user.all_teams.length > 0">
                                ...
                                <Dropdown align="right" width="48">
                                    <template #trigger>
                                        ...
                                        <span v-else class="inline-flex rounded-md">
                                            <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white dark:bg-gray-900 hover:text-gray-700 dark:hover:text-gray-100 dark:hover:bg-black focus:outline-none transition">
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                        ...
                        <div class="mt-3 space-y-1">
                            ...
                            <template v-if="$page.props.jetstream.hasTeamFeatures && $page.props.user.isMemberOfATeam">
                                ...
                                <!-- Team Settings -->
                                <ResponsiveNavLink v-if="$page.props.user.current_team" :href="route('teams.show', $page.props.user.current_team)" :active="route().current('teams.show')">
                                    Team Settings
                                </ResponsiveNavLink>
